...
public void createExceptionExcel(List<ErrorMsgDetail> errorMsglist,String outputFilePath,String hub) throws IOException {
	   ...
	   // font.setFontName("Arial");
	    ...
	    try (FileOutputStream outputStream = new FileOutputStream(outputFilePath)) {
	    	...
	    	controller.getErrorMsglist().add(new ErrorMsgDetail(FILE_RECORD_TYPE,"ACK","ACK Output Path don't have write access"));
	    		...
	    		ctoccontroller.getErrorMsglist().add(new ErrorMsgDetail(FILE_RECORD_TYPE,"ACK","ACK Output Path don't have write access"));
			e.printStackTrace();
